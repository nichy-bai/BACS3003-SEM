                        ...
                        <div class="md:mt-0">
                            ...
                            <div class="mx-auto max-w-lg ">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="absolute"><asp:RegularExpressionValidator ID="revUserChar" runat="server" ValidationGroup="RegisterValidation" ErrorMessage="Cannot contain whitespace." ControlToValidate="txtUserID" ForeColor="Red" ValidationExpression="^[A-Za-z0-9\[\]/!$%^&*()\-_+{};:'£@#.?]*$"></asp:RegularExpressionValidator></div>

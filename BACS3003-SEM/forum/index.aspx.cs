    ...
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (contentCookie != null)
            {
                ...
                if (content == "Recent")
                {
                    ...
                    content_recent_btn.CssClass = content_recent_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                    content_recent_btn.CssClass = content_recent_btn.CssClass.Replace("bg-white", "bg-gray-200");
                    content_featured_btn.CssClass = content_featured_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    content_featured_btn.CssClass = content_featured_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    content_trending_btn.CssClass = content_trending_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                ...
                else if (content == "Featured")
                {
                    ...
                    content_recent_btn.CssClass = content_recent_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    content_recent_btn.CssClass = content_recent_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    content_featured_btn.CssClass = content_featured_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                ...
                else if (content == "Trending")
                {
                    ...
                    content_featured_btn.CssClass = content_featured_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    content_featured_btn.CssClass = content_featured_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    content_trending_btn.CssClass = content_trending_btn.CssClass.Replace("text-gray-800", "text-blue-600");
            ...
            if (layoutCookie != null)
            {
                ...
                if (layout == "Classic")
                {
                    ...
                    layout_classic_btn.CssClass = layout_classic_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                    layout_classic_btn.CssClass = layout_classic_btn.CssClass.Replace("bg-white", "bg-gray-200");
                    layout_compact_btn.CssClass = layout_compact_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    layout_compact_btn.CssClass = layout_compact_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    layout_cozy_btn.CssClass = layout_cozy_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                ...
                else if (layout == "Compact")
                {
                    foreach (RepeaterItem item in Repeater1.Items)
                    {
                        ...
                        Panel p4 = (Panel)item.FindControl("tag_panel");
                        Panel p5 = (Panel)item.FindControl("cozy_content_panel");
                        p1.CssClass = "mx-5 mb-2 bg-white rounded-lg flex flex-col shadow-md h-auto dark:bg-dark-200 dark:text-gray-200 transition ease-in-out duration-1000";
                        p2.Visible = false;
                        p3.Visible = true;
                        p4.Visible = false;
                        p5.Visible = false;
                    ...
                    layout_classic_btn.CssClass = layout_classic_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    layout_classic_btn.CssClass = layout_classic_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    layout_compact_btn.CssClass = layout_compact_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                ...
                else if (layout == "Cozy")
                {
                    ...
                    layout_compact_btn.CssClass = layout_compact_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    layout_compact_btn.CssClass = layout_compact_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    layout_cozy_btn.CssClass = layout_cozy_btn.CssClass.Replace("text-gray-800", "text-blue-600");
            ...
            if (fontCookie != null)
            {
                ...
                if (font == "Small")
                {
                    ...
                    font_small_btn.CssClass = font_small_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                    font_small_btn.CssClass = font_small_btn.CssClass.Replace("bg-white", "bg-gray-200");
                    font_medium_btn.CssClass = font_medium_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    font_medium_btn.CssClass = font_medium_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    font_large_btn.CssClass = font_large_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                ...
                else if (font == "Medium")
                {
                    ...
                    font_small_btn.CssClass = font_small_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    font_small_btn.CssClass = font_small_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    font_medium_btn.CssClass = font_medium_btn.CssClass.Replace("text-gray-800", "text-blue-600");
                ...
                else if (font == "Large")
                {
                    ...
                    font_medium_btn.CssClass = font_medium_btn.CssClass.Replace("text-blue-600", "text-gray-800");
                    font_medium_btn.CssClass = font_medium_btn.CssClass.Replace("bg-gray-200", "bg-white");
                    font_large_btn.CssClass = font_large_btn.CssClass.Replace("text-gray-800", "text-blue-600");
        ...
        protected void postBody_btn_Command(object sender, CommandEventArgs e)
        {
            if (Session["UserID"] != null)
            {
                ...
                //Response.Redirect("showthread.aspx?p=" + postID);
                Response.Redirect("../Discussion/showthread.aspx?p=" + postID.Substring(2, postID.Length - 2));
            }
            else
            {

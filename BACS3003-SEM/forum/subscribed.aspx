<%@ Page Title="" Language="C#" MasterPageFile="~/Badcaps.Master" AutoEventWireup="true" CodeBehind="subscribed.aspx.cs" Inherits="BACS3003_SEM.forum.subscribed" %>
    ...
    <header
        ...
        <div class="relative px-0 flex flex-row flex-grow">
            <div class="flex flex-col justify-center">
                <span class="block text-4xl font-bold mb-2 font-title text-gray-700">Subscribed Thread</span>
                <span class="block opacity-80">Access your subscribed threads</span>
            </div>
        </div>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
        ...
        <FooterTemplate>
            <div class="flex flex-col justify-center items-center mx-5">
                <asp:Panel ID="noBookmark_panel" runat="server" Visible="false" CssClass="text-gray-300 mt-5 mb-2 md:mt-10">
                    <svg
                ...
                <asp:Label ID="noBookmark_lbl" runat="server" CssClass="text-gray-300 text-xl text-center font-medium mb-2" Text="You haven't bookmarked anything on RoundTable yet" Visible="false"></asp:Label>
                <asp:Label ID="noBookmark_lbl_2" runat="server" CssClass="text-gray-300 text-center mb-5" Text="Posts you bookmark will appear here" Visible="false"></asp:Label>
                <asp:LinkButton ID="homepage_btn" runat="server" Text="Go to homepage" CssClass="text-sm font-medium px-4 py-2 mb-0 md:mb-8 border-2 border-gray-300 text-gray-100 rounded-lg w-auto hover:bg-gray-700 hover:text-white transition ease-in-out duration-300" OnCommand="homepage_btn_Command" Visible="false"></asp:LinkButton>
                <asp:Label ID="footer_lbl" runat="server" CssClass="invisible text-gray-200 text-center mt-5" Text="There are no more bookmarks to show."></asp:Label>
            </div>
        </FooterTemplate>
    </asp:Repeater>
</asp:Content>

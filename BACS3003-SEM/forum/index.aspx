<%@ Page Title="" Language="C#" MasterPageFile="~/Badcaps.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BACS3003_SEM.forum.index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="personalize_panel" runat="server" Visible="false" CssClass="fixed w-full h-full top-0 left-0 flex items-center justify-center">
        ...
        <div class="bg-white w-11/12 md:max-w-lg mx-auto rounded-md shadow-md z-50 overflow-y-auto">
            <div class="py-5 text-left px-7">
                ...
                <div>
                    ...
                    <asp:Panel ID="content_panel" runat="server" CssClass="my-5 flex flex-row justify-center items-center">
                        <asp:LinkButton ID="content_recent_btn" runat="server" CssClass="w-32 flex flex-row flex-wrap justify-center items-center p-3 m-2 bg-gray-200 text-blue-600 rounded-lg hover:bg-gray-100 ease-in-out duration-300" OnCommand="content_recent_btn_Command">
                            <svg
                                class="w-8 h-8"
                                fill="none"
                                stroke="currentColor"
                    ...
                    <asp:Panel ID="layout_panel" runat="server" CssClass="my-5 flex flex-row justify-center items-center" Visible="false">
                        <asp:LinkButton ID="layout_classic_btn" runat="server" CssClass="w-32 flex flex-row flex-wrap justify-center items-center p-3 m-2 bg-gray-200 text-blue-600 rounded-lg hover:bg-gray-100 ease-in-out duration-300" OnCommand="layout_classic_btn_Command">
                            <svg
                                class="w-8 h-8"
                                fill="none"
                                stroke="currentColor"
                    ...
                    <asp:Panel ID="font_panel" runat="server" CssClass="my-5 flex flex-row justify-center items-center" Visible="false">
                        <asp:LinkButton ID="font_small_btn" runat="server" CssClass="w-32 flex flex-row flex-wrap justify-center items-center p-3 m-2 bg-gray-200 text-blue-600 rounded-lg hover:bg-gray-100 ease-in-out duration-300" OnCommand="font_small_btn_Command">
                            <svg
                                class="w-8 h-8"
                                fill="none"
                                stroke="currentColor"
        ...
        <ItemTemplate>
            <asp:Panel ID="post_panel" runat="server" CssClass="mt-0 m-5 bg-white rounded-md flex flex-col shadow-md h-auto transition ease-in-out duration-1000">
                <asp:LinkButton ID="postBody_btn" runat="server" CssClass="flex flex-col cursor-pointer hover:shadow-md hover:text-gray-800 p-5 px-6 rounded-lg transition ease-in-out duration-500 border-r-4 border-b-4 border-gray-400 hover:border-blue-400" OnCommand="postBody_btn_Command" CommandArgument='<%#Eval("postID") %>' OnClientClick="window.document.forms[0].target='_blank';">
                    ...
                    <asp:Panel ID="cozy_content_panel" runat="server" Visible="false" CssClass="flex flex-row flex-nowrap w-full mb-2 break-words" style="max-width:100vh;">
